#!/usr/bin/env python3
# experiments/phase5/formal/evaluate_replication_v4.py
"""
评估 v4 样本 (强制第一句)
"""
...
async def main():
    ...
    raw_dir = base_dir / "reports" / "raw_location_replication_v4"
    output_dir = base_dir / "reports" / "location_replication_results_v4"
    output_dir.mkdir(parents=True, exist_ok=True)

    print("="*80)
    print("Location Gap 复制验证评估 (v4 强制第一句): MP2 + MP3")
    print("="*80)
    ...
    output_path = output_dir / "replication_scores_v4.json"
